	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
...

		{
			...
			if (evento4Codice == null || evento4Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento4Colonna,
						risultatoconfronto, importogiocatofloat);
			...
			if (evento5Codice == null || evento5Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento5Colonna,
						risultatoconfronto, importogiocatofloat);
			...
			if (evento6Codice == null || evento6Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento6Colonna,
						risultatoconfronto, importogiocatofloat);
			...
			if (evento7Codice == null || evento7Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento7Colonna,
						risultatoconfronto, importogiocatofloat);
			...
			if (evento8Codice == null || evento8Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento8Colonna,
						risultatoconfronto, importogiocatofloat);
			...
			if (evento9Codice == null || evento9Codice.isEmpty()) {
				...
				conn1.InserimentoSchedina(codiceschedina, parametro, user, esitopartita, evento9Colonna,
						risultatoconfronto, importogiocatofloat);
